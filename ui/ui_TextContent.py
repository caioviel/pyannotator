...
#
# Created: Sun Nov 24 19:38:06 2013
...
class Ui_TextContent(object):
    def setupUi(self, TextContent):
        ...
        self.label_4.setGeometry(QtCore.QRect(110, 246, 41, 21))
        ...
        self.checkBox = QtGui.QCheckBox(TextContent)
        self.checkBox.setGeometry(QtCore.QRect(570, 240, 161, 31))
        ...
        self.widget = QtGui.QWidget(TextContent)
        self.widget.setGeometry(QtCore.QRect(20, 280, 700, 394))
    ...
    def retranslateUi(self, TextContent):
        ...
        self.checkBox.setText(QtGui.QApplication.translate("TextContent", "Fundo Transparente", None, QtGui.QApplication.UnicodeUTF8))
